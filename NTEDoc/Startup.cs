...
namespace NTEDoc
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UZZPContext>(options =>
                options.UseSqlServer(
                    Configuration.GetConnectionString("MainConnection"),
                        builder => builder.UseRowNumberForPaging()));
            ...
            var jwtSettingsSection = Configuration.GetSection("JwtTokenValidationSettings");
            services.Configure<JwtTokenValidationSettings>(jwtSettingsSection);

            var jwtSettings = jwtSettingsSection.Get<JwtTokenValidationSettings>();
